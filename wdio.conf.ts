...
export const config: WebdriverIO.Config = {
    ...
    capabilities: [{
        ...
        'LT:Options': {
            ...
            build: `WDIO Build - ${new Date().toISOString().slice(0, 10)}`,
            name: 'default',
            console: true,
            network: true,
            video: true,
            tunnel: false, // set true if you need to test local apps
        },
    ...
    logLevel: 'trace',
    outputDir: path.join(dirname, '/reports/logs'),
    //
    ...
    // 👇 Add LambdaTest hub + credentials
